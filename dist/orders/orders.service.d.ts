...
export declare class OrdersService {
    ...
    constructor(orderRepository: Repository<Order>, lineItemRepository: Repository<OrderLineItem>, productRepository: Repository<Product>, dataSource: DataSource, inventoryService: InventoryService, auditService: AuditService);
