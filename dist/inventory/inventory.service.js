...
let InventoryService = InventoryService_1 = class InventoryService {
    constructor(productRepository, dataSource, auditService) {
        this.productRepository = productRepository;
        this.dataSource = dataSource;
        this.auditService = auditService;
        this.logger = new common_1.Logger(InventoryService_1.name);
    }
    async decrementStock(dto, correlationId, orderId) {
        ...
        return this.dataSource.transaction(async function (manager) {
            return manager.createQueryBuilder(product_entity_1.Product, 'product')
                ...
                return manager.createQueryBuilder()
                    ...
                    await self.auditService.logInventoryDecrement(correlationId, dto.productId, previousStock, newStock, dto.quantity, orderId);
                    return {
                        success: true,
                        productId: dto.productId,
    ...
    async restoreStock(productId, quantity, correlationId, reason) {
        ...
        return this.dataSource.transaction(async function (manager) {
            return manager.createQueryBuilder(product_entity_1.Product, 'product')
                ...
                return manager.createQueryBuilder()
                    ...
                    await self.auditService.logInventoryRestore(correlationId, productId, previousStock, newStock, quantity, reason);
                    return {
                        success: true,
                        productId: productId,
                        previousStock: previousStock,
