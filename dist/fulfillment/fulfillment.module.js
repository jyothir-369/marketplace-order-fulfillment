...
const vendor_sync_isolated_processor_1 = require("./vendor-sync-isolated.processor");
...
exports.FulfillmentModule = FulfillmentModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([order_line_item_entity_1.OrderLineItem, vendor_sync_job_entity_1.VendorSyncJob, order_entity_1.Order, audit_1.AuditLog]),
            bullmq_1.BullModule.registerQueue({ name: vendor_sync_processor_1.VENDOR_SYNC_QUEUE }),
            bullmq_1.BullModule.registerQueue({ name: 'vendor-sync-base' }),
            bullmq_1.BullModule.registerQueue({ name: 'vendor-sync-isolated' }),
        ...
        providers: [
            ...
            vendor_sync_isolated_processor_1.VendorSyncIsolatedProcessor,
            vendor_queue_service_1.VendorQueueService,
            reconciliation_scheduler_1.ReconciliationScheduler,
        ],
        exports: [fulfillment_service_1.FulfillmentService, vendor_queue_service_1.VendorQueueService],
    })
], FulfillmentModule);
